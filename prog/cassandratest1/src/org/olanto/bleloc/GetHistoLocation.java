...
public class GetHistoLocation {
    ...
    public void getHistoXY() {
        ...
        ResultSet results = session.execute("SELECT ts10,shortname,x,y FROM repoble.histoxy");
        String result = "";
    ...
    public static void main(String[] args) {
        GetHistoLocation client = new GetHistoLocation();
