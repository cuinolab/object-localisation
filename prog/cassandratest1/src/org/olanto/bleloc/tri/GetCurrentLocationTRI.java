...
public class GetCurrentLocationTRI {
    ...
    public String getCurrentXY() {
        ...
        ResultSet results = session.execute("SELECT shortname,x,y FROM repoble.currentxyTRI");
        String result ="";
    ...
    public static void main(String[] args) {
         GetCurrentLocationTRI client = new GetCurrentLocationTRI();
        ...
        while (true) {
            ...
            try {
                ...
                Logger.getLogger(GetCurrentLocationTRI.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
